...
def test_show():
    ...
    assembly = Assembly(mmcif=SYMMETRICAL.joinpath(f"I/unrelaxed/native/6QCM.cif"), assembly_id="1",
                        rosetta_asymmetric_units= "EB FB GB HB C D F H L O KA LA MA NA OA PA QA RA SA TA UA VA WA XA YA ZA AB BB CB DB A B E G I J K M N P Q R S T U V W X Y Z AA BA CA DA EA FA GA HA IA JA")
