...
def test_matcher():
    ...
    chain_matches, tmscore, rmsd = matcher.apply(pose, pose_ref, pose_chains=(1,2), pose_ref_chains=(1,4), move_poses=True)
    rmsd_no_align = matcher.CA_rmsd_no_super(pose, pose_ref, *matcher.get_resis_from_chain_matches(pose, pose_ref, chain_matches))
    ...
    pose = pose_from_file("/home/mads/production/afoncubic/final/T/031122/output/1VEI_3_1/relaxed_model_2_multimer_v2_pred_0.pdb")
    pose_ref = pose_from_file("/home/shared/databases/SYMMETRICAL/T/idealized/crystal_repr/native/1VEI_crystal.pdb")
    chain_matches, tmscore, rmsd = matcher.apply(pose, pose_ref, pose_chains=(1,2), pose_ref_chains=(2,4), move_poses=True)
    rmsd_no_align = matcher.CA_rmsd_no_super(pose, pose_ref, *matcher.get_resis_from_chain_matches(pose, pose_ref, chain_matches))
    ...
    chain_matches, tmscore, rmsd = matcher.apply(pose, pose_ref, pose_chains=(1, 2, 3), pose_ref_chains=(1, 2, 3), move_poses=True)
    rmsd_no_align = matcher.CA_rmsd_no_super(pose, pose_ref, *matcher.get_resis_from_chain_matches(pose, pose_ref, chain_matches))
    ...
    pose = pose_from_file("/home/mads/production/afoncubic/final/T/031122/output/2CC9_3_1/relaxed_model_4_multimer_v2_pred_0.pdb")
    pose_ref = pose_from_file("/home/shared/databases/SYMMETRICAL/T/idealized/crystal_repr/native/2CC9_crystal.pdb")
    chain_matches, tmscore, rmsd = matcher.apply(pose, pose_ref, pose_chains=(1, 2, 3), pose_ref_chains=(1, 4, 7), move_poses=True)
    rmsd_no_align = matcher.CA_rmsd_no_super(pose, pose_ref, *matcher.get_resis_from_chain_matches(pose, pose_ref, chain_matches))
    ...
    pose = pose_from_file("/home/mads/production/afoncubic/final/T/031122/output/2CC9_3_1/relaxed_model_4_multimer_v2_pred_0.pdb")
    pose_ref = pose_from_file("/home/shared/databases/SYMMETRICAL/T/idealized/crystal_repr/native/2CC9_crystal.pdb")
    chain_matches, tmscore, rmsd = matcher.apply(pose, pose_ref, pose_chains=(2,3), pose_ref_chains=(1,5), move_poses=True)
    rmsd_no_align = matcher.CA_rmsd_no_super(pose, pose_ref, *matcher.get_resis_from_chain_matches(pose, pose_ref, chain_matches))
    ...
    pose = pose_from_file("/home/mads/production/afoncubic/final/T/031122/output/2CC9_3_1/relaxed_model_4_multimer_v2_pred_0.pdb")
    pose_ref = pose_from_file("/home/shared/databases/SYMMETRICAL/T/idealized/crystal_repr/native/2CC9_crystal.pdb")
    chain_matches, tmscore, rmsd = matcher.apply(pose, pose_ref, pose_chains=(1, 2), pose_ref_chains=(1, 5), move_poses=True)
    rmsd_no_align = matcher.CA_rmsd_no_super(pose, pose_ref, *matcher.get_resis_from_chain_matches(pose, pose_ref, chain_matches))
    ...
    pose = pose_from_file("/home/mads/production/afoncubic/final/T/031122/output/1VEI_3_1/relaxed_model_2_multimer_v2_pred_0.pdb")
    pose_ref = pose_from_file("/home/shared/databases/SYMMETRICAL/T/idealized/crystal_repr/native/1VEI_crystal.pdb")
    chain_matches, tmscore, rmsd = matcher.apply(pose, pose_ref, pose_chains=(1,2), pose_ref_chains=(1,5), move_poses=False)
    rmsd_no_align = matcher.CA_rmsd_no_super(pose, pose_ref, *matcher.get_resis_from_chain_matches(pose, pose_ref, chain_matches))
